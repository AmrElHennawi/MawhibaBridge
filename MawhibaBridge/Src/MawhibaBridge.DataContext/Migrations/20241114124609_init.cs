        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseCover = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TotalCourseHours = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CourseTypeId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseInstructorId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Instructors", x => x.CourseId);
                    table.ForeignKey(
                        name: "FK_Instructors_AspNetUsers_CourseInstructorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SectionSeenId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EnrollmentId = table.Column<int>(type: "int", nullable: false),
                    SectionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SectionSeens", x => x.SectionSeenId);
                    table.ForeignKey(
                        name: "FK_SectionSeens_Enrollments_EnrollmentId",
                        column: x => x.EnrollmentId,
                        principalTable: "Enrollments",
                        principalColumn: "EnrollmentId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SectionSeens_Sections_SectionId",
                        column: x => x.SectionId,
                        principalTable: "Sections",
                        principalColumn: "SectionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Instructors_CourseInstructorId",
                table: "Instructors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SectionSeens_EnrollmentId",
                table: "SectionSeens",
                column: "EnrollmentId");

            migrationBuilder.CreateIndex(
                name: "IX_SectionSeens_SectionId",
                table: "SectionSeens",
                column: "SectionId");
        }
